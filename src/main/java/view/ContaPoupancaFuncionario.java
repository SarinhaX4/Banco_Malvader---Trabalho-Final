 ...
 * @author Sarinha
 */
public class ContaPoupancaFuncionario extends javax.swing.JFrame {

    /**
     * Creates new form TelaLogin
     */
    public ContaPoupancaFuncionario() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel15.setText("Abrir Conta Poupança");

        jLabel16.setText("Senha do Cliente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContaPoupancaFuncionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ContaPoupancaFuncionario().setVisible(true);
            }
        });
    }
