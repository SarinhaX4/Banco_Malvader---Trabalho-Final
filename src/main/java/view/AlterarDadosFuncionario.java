 ...
 * @author Sarinha
 */
public class AlterarDadosFuncionario extends javax.swing.JFrame {

    /**
     * Creates new form TelaLogin
     */
    public AlterarDadosFuncionario() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Alterar Dados Funcionário");

        ButtonCliente.setText("Alterar Funcionário");
        ...
        ButtonFuncionario.setText("Alterar Conta");
        ...
        ButtonCliente1.setText("Alterar Cliente");
    ...
    private void ButtonClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonClienteActionPerformed
        AlterarFuncionario alterarFuncionarioView = new AlterarFuncionario();
        alterarFuncionarioView.setVisible(true);
        this.dispose();
    ...
    private void ButtonFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonFuncionarioActionPerformed
        AlterarConta alterarContaView = new AlterarConta();
        alterarContaView.setVisible(true);
        this.dispose();
    ...
    private void ButtonCliente1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonCliente1ActionPerformed
        AlterarCliente alterarClienteView = new AlterarCliente();
        alterarClienteView.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlterarDadosFuncionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlterarDadosFuncionario().setVisible(true);
            }
        });
    }
